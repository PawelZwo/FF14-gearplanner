# Generated by Django 4.2.6 on 2023-11-13 20:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acquisition', models.CharField(choices=[('NR', 'Normal Raid'), ('AR', 'Alliance Raid'), ('SR', 'Savage Raid'), ('TG', 'Tomestone Gear'), ('ATG', 'Augmented Tomestone Gear'), ('ETG', 'Exquisite Tomestone Weapon'), ('C_Normal_Q', 'Crafted Normal Quality'), ('C_High_Q', 'Crafted High Quality'), ('DD', 'Dungeon Drop'), ('RW', 'Relic Weapon')], db_comment='Way to obtain the api')),
